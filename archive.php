...
get_header();?>
    ...
    <div id="content">
        ...
        <div id="c2porduct-list">
            <?php if (is_category()) : ?>
                <!--If it Monthly Promotion -->            
                <?php if (is_category('64')) { ?>
                <div class="head-cat"><span>List of: <strong><?php single_cat_title(); ?></strong></span></div>            
                <?php } else {
                ?>
                <div class="head-cat"><span>Category: <strong><?php single_cat_title(); ?></strong></span></div>
                <?php } ?>
            <?php $itemcount = 1; ?>
            
            <ul <?php post_class('list-items'); ?>>
...
<?php if (get_post_meta($post->ID,'_gmp_org_price',true) != '') : ?>
                    <br />
                    <?php endif; ?>
		<?php } ?>
